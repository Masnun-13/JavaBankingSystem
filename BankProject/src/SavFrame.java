...
public class SavFrame extends JFrame {
	...
	public void addAcc()
	{
		...
		String with=limField.getText();
		String n=nameField.getText();
		Double bl=Double.parseDouble(bal);
		Double wl=Double.parseDouble(with);
		c.addAccount(n, bl, wl);
	}
	...
	public SavFrame() {
		...
		limField = new JTextField();
		limField.setColumns(10);
		limField.setBounds(124, 93, 246, 29);
		panel.add(limField);
		...
		JLabel lblWithdrawLimit = new JLabel("Withdraw Limit: ");
